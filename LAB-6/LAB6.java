...
class Student{
    ...
    Student(String regNo, String name, String email, String phno, String stdclass, String Department) {
        this.regNo = regNo;
        this.name = name;
        this.phno = phno;
        this.email = email;
    ...
    public String ConverttoString() {
        return (regNo + "," + name + "," + email + "," + phno + "," + stdclass + "," + Department);
...
public class LAB6{
    ...
    private static Student[] students = new Student[MAXi];
    ...
    private static void addStudent(Scanner scanner) {
        ...
        Student student = new Student(regNo, name, email, phno, stdclass, department);
    ...
    private static void updateStudent(Scanner scanner) {
        ...
        students[index] = new Student(regNo, name, email, phone, stdclass, department);
